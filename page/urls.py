...
from page.views import index, carousel_create, carousel_list, carousel_update, manage_list, page_list, page_create, \
    page_update, page_delete, page_show

urlpatterns = [
    path('', index, name='index'),
    path('manage/list/', manage_list, name='manage_list'),
